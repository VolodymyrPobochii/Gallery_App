...
public abstract class GalleryDBContent {
    ...
    public static final class GalleryImages extends GalleryDBContent {
        ...
        public static void createTable(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE " + TABLE_NAME + " (" + Columns.ID.getName() + " " + Columns.ID.getType() + ", " + Columns.IMAGE_NAME.getName() + " " + Columns.IMAGE_NAME.getType() + ", " + Columns.IMAGE_PATH.getName() + " " + Columns.IMAGE_PATH.getType() + ", " + Columns.IMAGE_TITLE.getName() + " " + Columns.IMAGE_TITLE.getType() + ", " + Columns.IMAGE_NOTES.getName() + " " + Columns.IMAGE_NOTES.getType() + ", " + Columns.CREATE_DATE.getName() + " " + Columns.CREATE_DATE.getType() + ", " + Columns.IS_SYNCED.getName() + " " + Columns.IS_SYNCED.getType() + ", PRIMARY KEY (" + Columns.ID.getName() + ")" + ");");
        ...
        static String getBulkInsertString() {
            return new StringBuilder("INSERT INTO ").append(TABLE_NAME).append(" ( ").append(Columns.ID.getName()).append(", ").append(Columns.IMAGE_NAME.getName()).append(", ").append(Columns.IMAGE_PATH.getName()).append(", ").append(Columns.IMAGE_TITLE.getName()).append(", ").append(Columns.IMAGE_NOTES.getName()).append(", ").append(Columns.CREATE_DATE.getName()).append(", ").append(Columns.IS_SYNCED.getName()).append(" ) VALUES (?, ?, ?, ?, ?, ?, ?)").toString();
        }
