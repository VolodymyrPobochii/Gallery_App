...
public class Config {
    ...
    public static final String DEFAULT_PARAM_DOMAIN = "103_FixedBoNames_Production.tenant41";
...
//    public static final String DEFAULT_DOMAIN = "/UA103_Production.tenant62";
    ...
    public static final String CAPTURE_SERVICE = "http://" + DEFAULT_HOST + ":" + DEFAULT_PORT + "/CPT.WebService/CaptureServiceRest.svc";
